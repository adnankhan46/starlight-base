...
function PrivacyPolicy() {
  return (
    ...
    <p>STARLIGHT FOUNDATION may change this Policy periodically and we urge you to check this page 
    for the latest version of the Policy in order to keep yourself updated.</p>
    </div>

    <div className="pp-middle-content">
    <div className="m1">
    ...
    <p><b>Note:</b> Not with standing anything under this Policy as required under applicable Indian laws, we will not 
...
or information collected from you will be strictly in accordance with applicable laws and guidelines.</p>
    ...
    <p><b><i>Right to Review -</i></b> You can review the data provided by you and can request us to correct or amend such 
    ...
    <p><b><i>Withdrawal of your Consent -</i></b> You can choose not to provide your data, at any time while availing our 
    goods or services or otherwise withdraw your consent provided to us earlier, in writing to our email ID: 
    teamstfo@gmail.com In the event you choose to not provide or later withdraw your consent, we may not 
    be able to provide you our services or goods.Please note that these rights are subject to our compliance 
